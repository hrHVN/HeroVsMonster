...
namespace HeroVsMonster
{
    public class Character 
    {
        ...
        public static int MaxHealth; // Default health before damage is subtracted

        public static string Weapon;
        public static string NewWeapon; // check if weapon is changed
        public static List<string> PreferedWeapon = new List<string>(); // Defined by class
